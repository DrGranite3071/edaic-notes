...
% ---------- TABLES (optional but usually needed) ----------
\usepackage{booktabs}
\usepackage{array}
\usepackage{tabularx}

% ---------- BOXES (EDA-style Summary) ----------
...
% show sections + subsections in the summary
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{coronary_circulation.png}
    \caption{Myocadial Boold Supply.}
    \label{fig:coronary_circulation}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{fast-resp_cells.png}
    \caption{Action potenntial in Fast-Response cells.}
    \label{fig:fast-resp_cells}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{slow-resp_cells.png}
    \caption{Membrane potential in Slow-responding cells.}
    \label{fig:slow-resp_cells}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{cardiac_cycle.png}
    \caption{Events of the cardiac cycle.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CVP_waveform.png}
    \caption{CVP trace.}
    \label{fig:CVP_waveform}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{PV_LV.png}
    \caption{Pressure-Volume curve of the LV.}
    \label{fig:PV_LV}
\end{figure}
...
\section{Chapter 30 --- Venous Return and Vascular Function}

\subsection{Veins as a capacitance system}
...
\subsection{Venous pathway, pressures, and flow velocity}
...
\subsubsection{Typical mean pressures}
\begin{itemize}
...
\subsubsection{Flow velocity and venous pulsations}
\begin{itemize}
...
\subsection{Venous distensibility and configurational change}
A defining property of veins is that \textbf{shape and compliance vary markedly with transmural pressure}.

\subsubsection{Pressure--configuration relationship}
\begin{itemize}
...
\subsection{Venomotor tone and control of venous capacitance}

\subsubsection{Innervation and mediators}
\begin{itemize}
...
\subsubsection{Venomotor tone and reflex control}
\begin{itemize}
...
\subsection{Determinants of venous return}
...
\subsection{Mean systemic filling pressure and the driving gradient}
...
\subsubsection{What changes MSFP}
\begin{itemize}
...
\subsubsection{Pressure gradient for venous return}
...
\subsection{Venous valves and one-way flow}
\begin{itemize}
...
\subsection{Mechanisms that augment venous return}

\subsubsection{Skeletal muscle pump}
\begin{itemize}
...
\subsubsection{Respiratory pump}
During inspiration:
\begin{itemize}
...
\subsubsection{Effects of ventricular contraction and relaxation}
\begin{itemize}
...
\subsection{Posture and venous return}
...
\subsubsection{Cerebral venous sinuses and the sitting position}
\begin{itemize}
...
\subsection{The venous return curve (Guyton)}

\subsubsection{Experimental basis: right heart bypass}
\begin{itemize}
...
\subsubsection{Linear range and governing equation}
\begin{itemize}
...
\subsubsection{Negative RAP: plateau (Starling resistor behaviour)}
...
\subsection{Changing MSFP: parallel shifts of the venous return curve}
...
\subsection{Changing resistance to venous return: altering slope}
...
\subsection{Venous return and cardiac output: cardiac function curve and equilibrium point}

\subsubsection{Cardiac output curve (Guyton)}
...
\subsubsection{Equilibrium point (venous return = cardiac output)}
...
\subsubsection{Sympathetic tone shifts both curves}
\begin{itemize}
...
\subsection{High-yield takeaways and common traps}
\begin{itemize}
...
\section{Chapter 31 --- Regulation of Arterial Blood Pressure}

\subsection{Objectives and overall framework}
...
\subsection{Functional organization of cardiovascular regulation}
...
\subsubsection{Medullary and spinal components}
...
\subsection{The arterial baroreceptor reflex}
...
\subsubsection{Sensors and location}
...
\subsubsection{Afferent pathways}
\begin{itemize}
...
\subsubsection{What is sensed: mean pressure and pulsatility}
Baroreceptors sense:
\begin{itemize}
...
\subsubsection{Central integration and efferent response}
\begin{itemize}
...
\subsubsection{Operating range and saturation}
...
\subsubsection{Tonic activity and beat-to-beat modulation}
...
\subsubsection{Resetting and the role of the reflex}
...
\subsection{Cardiopulmonary (low-pressure) baroreceptors}
...
\subsubsection{Venoatrial stretch receptors (A and B fibres)}
...
\subsubsection{Cardiac mechanoreceptors and the Bezold--Jarisch reflex}
...
\subsubsection{Chemosensitive cardiac afferents}
...
\subsection{Peripheral chemoreceptors}
...
\subsection{Short-term control: central integration and higher-centre modulation}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{st_control_MAP.png}
    \caption{Inspiratory work of breathing.}
    \label{fig:st_control_MAP}
\end{figure}

\subsubsection{Central sympathetic cells}
\begin{itemize}
...
\subsubsection{Central parasympathetic neurones}
...
\subsubsection{Other CNS influences}
\begin{itemize}
...
\subsection{Efferent pathways and effectors}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{neg_feedback_BP.png}
    \caption{Negative feedback of BP.}
    \label{fig:neg_feedback_BP}
\end{figure}

\subsection{Negative feedback control of arterial pressure}
...
\subsection{Long-term regulation of arterial blood pressure}
...
\subsubsection{Cardiopulmonary receptors, ANP, and volume control}
...
\section{Chapter 32 --- Integrated Cardiovascular Responses}

\subsection{Haemorrhage}
...
\subsubsection{Hormonal responses}
...
\subsubsection{Haematological responses}
\begin{itemize}
...
\subsubsection{Summary of cardiovascular responses to haemorrhage (Table 32.1)}
...
\subsubsection{Guyton framework: shifts in venous return and cardiac output curves}
...
\subsubsection{Common pathophysiology in severe shock}
...
\subsubsection{Responses to shock: neural and endocrine}
...
\subsection{Hypovolaemic and distributive shock}

\subsubsection{Hypovolaemic shock and clinical staging of haemorrhagic shock (Table 32.3)}
...
\subsubsection{Distributive shock (sepsis and anaphylaxis)}
...
\subsection{Cardiogenic and obstructive shock}

\subsubsection{Cardiogenic shock}
...
\subsubsection{Obstructive shock}
...
\subsection{The Valsalva manoeuvre}
...
\subsection{Physiology of cardiopulmonary exercise testing}
...
\subsubsection{Cardiovascular response to exercise}
...
\subsubsection{Ventilatory response to exercise}
...
\subsubsection{Respiratory exchange ratio}
\[
...
\subsubsection{Ventilatory equivalent for CO$_2$ (VE/VCO$_2$)}
\begin{itemize}
...
\subsubsection{CPET for perioperative risk stratification}
...
\subsection{Physiological consequences of a pneumoperitoneum}
...
\subsubsection{Effects of increased intra-abdominal pressure}
Cardiovascular:
\begin{itemize}
...
\subsubsection{Effects of CO$_2$ absorption}
\begin{itemize}
